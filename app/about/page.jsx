  ...
  return (
    <div className="pt-16">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-4xl font-bold text-amber-800 mb-6">Welcome to Agraharam Cafe</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg p-8 shadow-lg">
              <div className="text-amber-600 text-4xl mb-6 flex justify-center">
                <GiIndianPalace />
              </div>
              <h3 className="text-3xl font-bold text-amber-800 mb-4 text-center">Our Mission</h3>
      ...
      <section className="py-20 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-700 text-lg">The principles that guide everything we do</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-amber-800 mb-4">Our Specialties</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              />
              <h3 className="text-xl font-semibold text-amber-800 mb-2">South Indian Classics</h3>
            ...
            <div className="text-center">
              <img 
                ...
                className="rounded-lg shadow-lg w-full h-48 object-cover mb-4"
              />
              <h3 className="text-xl font-semibold text-amber-800 mb-2">Fusion Innovations</h3>
              <p className="text-gray-600">
