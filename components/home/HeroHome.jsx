...
const HeroHome = () => {
    ...
    return (
        <section className="relative md:py-32 py-20 flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute top-10 left-10 w-16 sm:w-20 md:w-24 h-16 sm:h-20 md:h-24 border-4 border-green-800 opacity-30 rounded-full animate-pulse"></div>
            <div className="absolute bottom-10 right-10 w-20 sm:w-28 md:w-32 h-20 sm:h-28 md:h-32 border-4 border-green-700 opacity-20 rounded-full animate-ping"></div>

            {/* Content */}
            <div className="relative z-10 text-center max-w-4xl mx-auto px-4 mt-10 text-white">
                {/* Tagline */}
                <div data-aos="fade-down" className="mb-6">
                    <span className="text-white font-semibold tracking-widest text-[7px] md:text-[17px] sm:text-[6px] md:text-base uppercase border-2 border-green-700 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-black/30 backdrop-blur-md shadow-lg font-serif">
                ...
                >
                    ...
                    <span className="block pb-2 text-green-400 mt-1 sm:mt-2 italic font-serif">
                        Café
                    </span>
                </h1>
                ...
                <div data-aos="fade-up" data-aos-delay="500" className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mt-3">
                    ...
                    <Link
                        href="/contact"
                        className="bg-transparent border-2 bg-green-700 border-green-600 px-10 rounded-md py-3 hover:bg-green-800 hover:text-white transition font-serif"
                    >
                        Reserve Table
                    </Link>
                </div>
