  ...
  return (
    <section className="md:py-24 py-8 relative overflow-hidden bg-gradient-to-b from-[#f8f8f5] via-white to-[#f8f8f5]">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 border-2 border-[#c9a66b] rounded-full"></div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Hover effect border */}
                <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-[#c9a66b]/20 transition-all duration-500"></div>

                {/* Icon */}
                <div className="relative z-10 w-20 h-20 mx-auto flex items-center justify-center rounded-2xl bg-gradient-to-br from-[#306c36] to-[#1b3c20] text-white text-3xl mb-6 group-hover:from-[#c9a66b] group-hover:to-[#a88448] group-hover:scale-105 transition-all duration-500 shadow-md">
                  <IconComponent />
                </div>
